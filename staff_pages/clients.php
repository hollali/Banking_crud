...
<head>
    ...
    <title>Client Database For Staff</title>
    <!--Bootstrap css-->
...
<body>
    <h1 class=" bg-dark text-light text-center w-100 z-1">STAFF PANEL</h1>
    <div class="container">
                        ...
                        <div>
                            ...
                            <div class="form-group w-50 my-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border border-warning rounded-end-pill" placeholder="Enter Identification Number" autocomplete="off" required="required" id="IdNum" name="IdNum">
                                </div>
                            </div>
                            <!--email-->
                            <div class="form-group w-50 my-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border border-warning rounded-end-pill" placeholder="Enter Email Address" autocomplete="off" required="required" id="email" name="email" maxlength="20">
                                </div>
                            </div>
                            <!--gender-->
                            <div class="form-group w-50 my-3">
        ...
        <div class="col-7">
            <form method="post">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control border border-success rounded-start-pill text-center" placeholder="Search Data" name="search" autocomplete="off">
                    ...
                    if (isset($_POST['send'])) {
                        ...
                        if ($result) {
                            ...
                            <tr>
                                ...
                                <td>' . $row['email'] . '</td>
                                <td>
                                <a href="../admin_pages/admin_view.php?viewid=' . $id . '"class="text-light text-decoration-none"><i class="fa fa-eye text-primary mx-2" aria-hidden="true"></i></a>
                                <a href="../backend/remove.php?deleteid=' . $id . '"class="text-light text-decoration-none"><i class="fa fa-trash text-danger" aria-hidden="true"></i></a>
                                </td>
                                </tr>
                                </tbody>';
                                };
    ...
    <nav aria-label="breadcrumb" class="float-end mx-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../staff_pages/staff_dashboard.php" class="text-decoration-none">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page" class="text-decoration-none">Client</li>
        </ol>
    </nav>
    <!--Table Content--->
        ...
        <tbody>
            ...
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <td>' . $tot . '</td>
                    <td>
                    <a href="../admin_pages/admin_view.php?viewid=' . $id . '"class="text-light text-decoration-none"><i class="fa fa-eye text-primary mx-3" aria-hidden="true"></i></a>
                    <a href="../backend/remove.php?deleteid=' . $id . '"class="text-light text-decoration-none"><i class="fa fa-trash text-danger" aria-hidden="true"></i></a>
                    </td>
                    </tr>';
                }
    ...
    for ($btn = 1; $btn <= $totalPages; $btn++) {
        echo '<button class="btn btn-primary mx-3 my-3"><a href="display.php?page=' . $btn . '" class="text-light text-decoration-none">' . $btn . '</a></button>';
    }
    if (isset($_GET['page'])) {
        $page = $_GET['page'];
    } else {
    ...
    $sql = "Select * from `data` limit " . $startinglimit . ',' . $numPages;
    $result = mysqli_query($con, $sql);
    */ ?>
    <!--JS--->
    <script>
